...
a.s.index;e.updateArrows(1<b.s.criteria.length,!1);b.addCriteria(e,!1);return!1});a.setListeners()};c.prototype._setup=function(){this.setListeners();q(this.dom.add).text(this.s.dt.i18n("searchBuilder.add","Tambah Kondisi"));q(this.dom.logic).text("OR"===this.c.logic?this.s.dt.i18n("searchBuilder.logicOr","Or"):this.s.dt.i18n("searchBuilder.logicAnd","And"));this.s.logic="OR"===this.c.logic?"OR":"AND";this.c.greyscale&&q(this.dom.logic).addClass(this.classes.greyscale);q(this.dom.logicContainer).append(this.dom.logic).append(this.dom.clear);
...
a=new z.Api(a);this.classes=n.extend(!0,{},c.classes);this.c=n.extend(!0,{},c.defaults,b);this.dom={clearAll:n('<button type="button">'+a.i18n("searchBuilder.clearAll","Hapus Semua")+"</button>").addClass(this.classes.clearAll).addClass(this.classes.button),container:n("<div/>").addClass(this.classes.container),title:n("<div/>").addClass(this.classes.title),titleRow:n("<div/>").addClass(this.classes.titleRow),topGroup:void 0};this.s={dt:a,opts:b,search:void 0,topGroup:void 0};if(void 0===a.settings()[0]._searchBuilder){a.settings()[0]._searchBuilder=
